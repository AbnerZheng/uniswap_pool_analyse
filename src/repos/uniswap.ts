  ...
  return [
    {
      position: {
        ...
        tickLower: {
          tickIdx: "-269520",
          feeGrowthOutside0X128: "97661248148125547684448196768021240543344391",
          feeGrowthOutside1X128: "109451100873023280347815874798417",
        },
        tickUpper: {
          tickIdx: "-267900",
      ...
      pool: {
        ...
        token0Price: "0.4749286254766438564584513405355676",
        token1Price: "2.105579546813773216399927156179666",
        feeGrowthGlobal0X128: "110509679889600322070032469643452317037417653",
        feeGrowthGlobal1X128: "140725729930869711693964960855964",
        feeTier: "3000",
        sqrtPrice: "114964938252057688752761",
        liquidity: "4907525795364150640",
      },
      liquidity: "199486544038781090",
    ...
    },
    {
      ...
      pool: {
        ...
        token0Price: "2.106379922861321100405517503350666",
        token1Price: "0.4747481634944531100612433170368229",
        feeGrowthGlobal0X128: "4988400598397697307212798207377",
        feeGrowthGlobal1X128: "2410903612311677920134678476970147385733890",
        feeTier: "3000",
        sqrtPrice: "54589765716136494284215150578087937",
        liquidity: "1472955380705292427",
      },
      liquidity: "0",
    ...
    },
    {
      position: {
        ...
        tickLower: {
          tickIdx: "-269040",
          feeGrowthOutside0X128: "98673354017912639938455446016761169354753631",
          feeGrowthOutside1X128: "111532692615650901119422627507969",
        },
        tickUpper: {
          tickIdx: "-267720",
    ...
    },
    {
      position: {
        ...
        tickLower: {
          tickIdx: "-269400",
          feeGrowthOutside0X128: "97027231206378559074593823771123228023345304",
          feeGrowthOutside1X128: "108018544197725008402876374977463",
        },
        tickUpper: {
          tickIdx: "-267240",
    ...
    },
    {
      ...
      pool: {
        ...
        token0Price: "0.0009776764979193140159441183139647281",
        token1Price: "1022.833219503787545111582230795354",
        feeGrowthGlobal0X128:
          "408629739974704800581961673811967727016289931708807",
        feeGrowthGlobal1X128: "3748303694667741681684632087063382433415",
        feeTier: "3000",
        sqrtPrice: "2533856384477693875963188019049",
        liquidity: "888403850133825725883264",
      },
      liquidity: "0",
    ...
    },
    {
      ...
      pool: {
        ...
        token0Price: "0.0009779038497192606419271266927347806",
        token1Price: "1022.595422123640051499183294027721",
        feeGrowthGlobal0X128: "6043748998502402178693694163877290848",
        feeGrowthGlobal1X128: "5372069951470705153058042406206928522243",
        feeTier: "10000",
        sqrtPrice: "2533561820601734709564165954333",
        liquidity: "9296460013238461193834",
      },
      liquidity: "0",
...
export const getPositionSnapshots = async (
  ...
  for (let i = positionSnapshots.length - 1; i >= 0; i--) {
    ...
    if (
      ...
      lpHoldingRecords.push({
        ...
        tokenSymbol0: p.pool.token0.symbol,
        tokenID1: p.pool.token1.id,
        tokenSymbol1: p.pool.token1.symbol,
  ...
  for (const r1 of lpHoldingRecords.filter((r) => r.opening)) {
    ...
    const tokenA = new V3Token(
      ...
      r1.tokenID0,
      Number(positionSnapshot?.pool.token0.decimals)
    );
    const tokenB = new V3Token(
      getCurrentNetwork().chainId,
      r1.tokenID1,
      Number(positionSnapshot?.pool.token1.decimals)
    );
    const v3Pool = new V3Pool(
      tokenA,
      tokenB,
      Number(r1.feeTier),
      positionSnapshot!.pool.sqrtPrice,
      positionSnapshot!.pool.liquidity,
      Number(positionSnapshot?.pool.tick)
    );
    const position = new V3Position({
      pool: v3Pool,
      liquidity: Number(positionSnapshot!.liquidity),
      tickLower: Number(positionSnapshot!.position.tickLower.tickIdx),
      tickUpper: Number(positionSnapshot!.position.tickUpper.tickIdx),
    });
